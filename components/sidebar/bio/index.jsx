    ...
    <div className="contactInfo">
      <ul>
        <li>
          ...
          <a
            href="https://www.google.com/maps/place/Riol%C3%A2ndia,+SP,+15495-000/"
            target="_blank"
          >
            Riolândia, São Paulo, Brasil
          </a>
        </li>
        <li>
          <svg
        ...
        <li>
          ...
          <a href="https://github.com/danielvilarcosta" target="_blank">
            danielvilarcosta
          </a>
        </li>
        <li>
          ...
          <a
            href="https://www.linkedin.com/in/daniel-vilar-costa-73623a277/"
            target="_blank"
          >
            daniel-vilar-costa
          </a>
        ...
        <li>
          ...
          <a href="https://devinhouse.tech/" target="_blank">
            {" "}
            Daniel Vilar Costa
          </a>
        </li>
        <li>
          ...
          <a href="mailto:danielvilar12@gmail.com">danielvilar12@gmail.com</a>
        </li>
      </ul>
    </div>
  );
