  ...
  return (
    <div className="fill">
      <div className="cardContenent">
        ...
        <div className="text">
          <p>
            Estou fazendo transição de carreira para Desenvolvedor JR Full Stack
            Sou Formado em Sistemas de Informações pela Unifev Centro
            Universitário de Votuporanga Atualmente estou realizando o curso do
            Senai Devinhouse
          </p>
        </div>
      </div>
